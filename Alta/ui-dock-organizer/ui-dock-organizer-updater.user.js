...
(function () {
  ...
  const TARGET_ID = 'ui-dock-organizer';
  const TARGET_LABEL = 'Cross-Origin UI Dock Organizer';
  const TARGET_FILE = 'ui-dock-organizer.user.js';
  const BASE_URL = 'https://raw.githubusercontent.com/ugomez809/TamperMonkey-Automatic-Quote-New/main/Alta/ui-dock-organizer';
