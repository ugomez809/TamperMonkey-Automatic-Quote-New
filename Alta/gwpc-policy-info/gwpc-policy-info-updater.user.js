// ==UserScript==
// @name         GWPC Policy Info Prefill Updater
// @namespace    homebot.gwpc-policy-info.updater
// @version      0.1.0
// @description  Loads and auto-updates the GWPC Policy Info Prefill script from GitHub.
// @author       OpenAI
...
// @connect      *
// @updateURL    https://raw.githubusercontent.com/ugomez809/TamperMonkey-Automatic-Quote-New/main/Alta/gwpc-policy-info/gwpc-policy-info-updater.user.js
// @downloadURL  https://raw.githubusercontent.com/ugomez809/TamperMonkey-Automatic-Quote-New/main/Alta/gwpc-policy-info/gwpc-policy-info-updater.user.js
// ==/UserScript==

(function () {
  'use strict';
  const LOADER_VERSION = '0.1.0';
  const TARGET_ID = 'gwpc-policy-info';
  const TARGET_LABEL = 'GWPC Policy Info Prefill';
  const TARGET_FILE = 'gwpc-policy-info.user.js';
  const BASE_URL = 'https://raw.githubusercontent.com/ugomez809/TamperMonkey-Automatic-Quote-New/main/Alta/gwpc-policy-info';
