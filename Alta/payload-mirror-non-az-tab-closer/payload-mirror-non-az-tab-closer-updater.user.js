// ==UserScript==
// @name         GWPC Payload Mirror + Non-AZ Tab Closer Updater
// @namespace    homebot.payload-mirror-non-az-tab-closer.updater
// @version      0.1.0
// @description  Loads and auto-updates the GWPC Payload Mirror + Non-AZ Tab Closer script from GitHub.
// @author       OpenAI
...
(function () {
  ...
  const TARGET_LABEL = 'GWPC Payload Mirror + Non-AZ Tab Closer';
