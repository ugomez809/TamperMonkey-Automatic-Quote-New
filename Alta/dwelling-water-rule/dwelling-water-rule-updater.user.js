// ==UserScript==
// @name         GWPC Dwelling Water Rule Updater
// @namespace    homebot.dwelling-water-rule.updater
// @version      0.1.0
// @description  Loads and auto-updates the GWPC Dwelling Water Rule script from GitHub.
// @author       OpenAI
...
// @connect      *
// @updateURL    https://raw.githubusercontent.com/ugomez809/TamperMonkey-Automatic-Quote-New/main/Alta/dwelling-water-rule/dwelling-water-rule-updater.user.js
// @downloadURL  https://raw.githubusercontent.com/ugomez809/TamperMonkey-Automatic-Quote-New/main/Alta/dwelling-water-rule/dwelling-water-rule-updater.user.js
// ==/UserScript==

(function () {
  'use strict';
  const LOADER_VERSION = '0.1.0';
  const TARGET_ID = 'dwelling-water-rule';
  const TARGET_LABEL = 'GWPC Dwelling Water Rule';
  const TARGET_FILE = 'dwelling-water-rule.user.js';
  const BASE_URL = 'https://raw.githubusercontent.com/ugomez809/TamperMonkey-Automatic-Quote-New/main/Alta/dwelling-water-rule';
