// ==UserScript==
// @name         GWPC Popup Blocker Updater
// @namespace    homebot.gwpc-popup-blocker.updater
// @version      0.1.0
// @description  Loads and auto-updates the GWPC Popup Blocker script from GitHub.
// @author       OpenAI
...
// @connect      *
// @updateURL    https://raw.githubusercontent.com/ugomez809/TamperMonkey-Automatic-Quote-New/main/Alta/gwpc-popup-blocker/gwpc-popup-blocker-updater.user.js
// @downloadURL  https://raw.githubusercontent.com/ugomez809/TamperMonkey-Automatic-Quote-New/main/Alta/gwpc-popup-blocker/gwpc-popup-blocker-updater.user.js
// ==/UserScript==

(function () {
  'use strict';
  const LOADER_VERSION = '0.1.0';
  const TARGET_ID = 'gwpc-popup-blocker';
  const TARGET_LABEL = 'GWPC Popup Blocker';
  const TARGET_FILE = 'gwpc-popup-blocker.user.js';
  const BASE_URL = 'https://raw.githubusercontent.com/ugomez809/TamperMonkey-Automatic-Quote-New/main/Alta/gwpc-popup-blocker';
